...
def two_window(level):
    ...
    if level == "easy":
        ...
        messages = ["Увага! Ти наблизився до Зірки Смерті!", "Твоя ціль - знищити її сотнями пострілами!", "Будь обережний, його атаки нищівні і в тебе 10 життів!", "Знищи його, і галактика буде врятована!", "Приготуйся до вирішальної битви через 11 секунд!"]
        delay = 7
